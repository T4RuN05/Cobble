...
auto Palette::default_palette() -> const std::string {
    ...
    d << "GIMP Palette\n"
      << "Name: Cobble Palette\n"
      << "#\n"
      << 212 << " " << 212 << " " << 212 << " " << NC_("Color", "White (Text)") << "\n"
      << 30 << " " << 30 << " " << 30 << " " << NC_("Color", "Black (BG)") << "\n"
      << 86 << " " << 156 << " " << 214 << " " << NC_("Color", "Blue (Keyword)") << "\n"
      << 156 << " " << 220 << " " << 254 << " " << NC_("Color", "Light Blue (Var)") << "\n"
      << 78 << " " << 201 << " " << 176 << " " << NC_("Color", "Teal (Type)") << "\n"
      << 181 << " " << 206 << " " << 168 << " " << NC_("Color", "Green (String)") << "\n"
      << 220 << " " << 220 << " " << 170 << " " << NC_("Color", "Yellow (Func)") << "\n"
      << 206 << " " << 145 << " " << 120 << " " << NC_("Color", "Orange (String)") << "\n"
      << 244 << " " << 71 << " " << 71 << " " << NC_("Color", "Red (Error)") << "\n"
      << 197 << " " << 134 << " " << 192 << " " << NC_("Color", "Magenta (Control)") << "\n"
      << 128 << " " << 128 << " " << 128 << " " << NC_("Color", "Gray (Comment)") << std::endl;
    return d.str();
}
...
auto Palette::parseErrorDialog(const std::exception& e) const -> void {
    ...
    msg_stream << "Please fix your palette file, or rename it so Cobble creates a new default palette file "
